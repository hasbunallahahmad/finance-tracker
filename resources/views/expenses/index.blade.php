        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                ...
                <div class="mb-6 p-6 bg-gray-50 border border-gray-200 rounded-lg">
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Tambah Pengeluaran Baru</h3>
                ...
                <!-- Daftar Pengeluaran -->
                <div>
                    <h3 class="text-lg font-medium text-gray-900 mb-4">Riwayat Pengeluaran</h3>
                            ...
                            <table class="min-w-full bg-white">
                                ...
                                <tbody>
                                    @foreach ($expenses as $expense)
                                        <tr>
                                            <td class="py-2 px-4 border-b">{{ $expense->date->format('d-m-Y') }}</td>
                                            <td class="py-2 px-4 border-b">
                                                <div>{{ $expense->title }}</div>
                                                @if ($expense->description)
                                                    <div class="text-xs text-gray-500">
                                                        {{ Str::limit($expense->description, 50) }}</div>
                                                @endif
                                            </td>
                                            <td class="py-2 px-4 border-b">
